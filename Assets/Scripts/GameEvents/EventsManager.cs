...
{
    private static readonly Dictionary<Type, Action<GameEvent>> activeEvents = new();
    private static readonly Dictionary<Delegate, Action<GameEvent>> actionsLookup = new();
